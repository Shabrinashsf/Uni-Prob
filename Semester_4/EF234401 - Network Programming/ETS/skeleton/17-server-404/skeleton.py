...
def get_response(path: str) -> bytes:
    ?
...
class TestServer404(unittest.TestCase):
    @patch('socket.socket')
    ...
    def test_get_response(self):
        ...
        response_200 = get_response('/index.html')
        assert_in(b'200 OK', response_200)
        response_404 = get_response('/missing.html')
        assert_in(b'404 Not Found', response_404)
    ...
    def test_serve(self, mock_socket, mock_select):
        ...
        mock_client_socket.recv.return_value = b'GET /index.html HTTP/1.1\r\nHost: localhost\r\n\r\n'
