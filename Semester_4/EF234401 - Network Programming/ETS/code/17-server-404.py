...
class TestServerRoutes(unittest.TestCase):
    ...
    def test_get_response(self):
        ...
        assert_in(b'200 OK', get_response('/'))
        assert_in(b'404 Not Found', get_response('/unknown'))
    ...
    def test_serve(self, mock_socket, mock_select):
        ...
        expected_call = call(('localhost', 8080))
        assert_equal(mock_server_socket.bind.call_args, expected_call)
